        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                ...
                <div class="ml-0 pl-0 supportInfo container d-inline-flex">
                    ...
                    <h4 class="mb-5 h4" ><b><c:out value="| ${atendimento.status}" /> - Resolver</b></h4>
                </div>
                <form action="main.jsp" class="mb-5">
                    <div class="form-row">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1"
                                      rows="3" disabled><c:out value="${atendimento.solution}" /></textarea>
                        </div>
                    </div>
                    <a href="openrequests" class="btn btn-dark">Voltar</a>
                </form>
            </div>
        </div>
    </body>
