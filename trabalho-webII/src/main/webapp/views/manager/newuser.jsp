        ...
        <main>
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <h1 class="mb-5">Inserir usuário</h1>
                    <form method="post" action="#" class="mb-5">
                        <div class="form-row">
                            <div class="form-group col-md-6 mb-3">
                                <label for="inputCategory">Tipo</label><br/>
                                <select id="inputCategory" class="custom-select" name="role">
                                    <option value="funcionario" selected>Funcinário</option>
                                    <option value="gerente">Gerente</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <label for="name">Primeiro nome</label> <input type="text" name="name"
                                                                               class="form-control" id="inputFirstName" placeholder="Maria"
                                                                               required>
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <label for="inputLastName">Sobrenome</label> <input type="text" name="lastname"
                                                                                    class="form-control" id="inputLastName" placeholder="Luceia"
                                                                                    required>
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <label for="inputCPF">CPF</label> <input type="text" name="cpf"
                                                                         class="form-control" id="inputCPF" placeholder="00000000000"
                                                                         >
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <label for="inputEmail4">E-mail</label> <input type="email" name="email"
                                                                               class="form-control" id="inputEmail4"
                                                                               placeholder="test@email.com" >
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <label for="inputPassword5">Senha</label> <input name="password"
                                                                                 type="password" class="form-control" id="inputPassword5"
                                                                                 placeholder="Senha">
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <label for="inputPassword6">Confirmar senha</label> <input name="confirmPassword"
                        ...
                        <div class="form-group">
                            <div class="form-group col-md-2 mb-3">
                                <label for="inputZip">CEP</label> <input type="text" name="cep"
                                                                         class="form-control" id="inputZip" 
                                                                         required>
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <label for="inputAddress">Logradouro</label> <input type="text" name="address"
                                                                                    class="form-control" id="inputAddress" placeholder="Rua, número"
                                                                                    required>
                            </div>
                        </div>
                        <div class="form-group col-md-2 mb-3">
                            <label for="inputAddress2">Número</label> <input type="text" name="adressNumber"
                                                                             class="form-control" id="inputAddress2" placeholder="334"
                                                                             required>
                        </div>
                        <div class="form-group col-md-6 mb-3">
                            <label for="inputAddress3">Complemento</label> <input type="text" name="complement"
                                                                                  class="form-control" id="inputAddress3"
                                                                                  placeholder="Apartamento, bloco, estúdio">
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6 mb-3">
                                <label for="inputHood">Bairro</label> <input type="text" name="bairro"
                                                                             class="form-control" id="inputHood" required >
                            </div>
                            <div class="form-group col-md-6 mb-3">
                                <label for="inputCity">Cidade</label> <input type="text" name="city"
                                                                             class="form-control" id="inputCity" required >
                            </div>
                            <div class="form-group col-md-2 mb-3">
                                <label for="inputCity">Estado</label> <input type="text" name="state"
