    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <h1 class="mb-3 h1">Categoria <c:out value="${categoy.cat_id}"/></h1>
                <form action="" method="post" class="mb-5">
                    <div class="form-row">
                        <div class="form-group col-md-6 mb-3">
                            <label for="name">Nome da categoria</label> <input
                                type="text" class="form-control" id="inputShortDescriptive" name="name" value="${category.name}"
                                required>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-success">Salvar edição</button>
                    <a href="categories" class="btn btn-dark">Voltar</a>
                </form>
            </div>
        </div>
    </body>
