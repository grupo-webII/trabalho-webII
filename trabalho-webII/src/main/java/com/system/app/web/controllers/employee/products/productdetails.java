 ...
 * @author costiss
 */
@WebServlet(name = "employeeProductdetails", urlPatterns = { "/employee/productdetails" })
public class productdetails extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Product product = productRepo.getByID(Integer.parseInt(request.getParameter("id")));
