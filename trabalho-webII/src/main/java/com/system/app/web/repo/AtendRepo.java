...
public class AtendRepo implements DAOinterface<Atendimento> {
    ...
    public boolean save(Atendimento attend) throws DAOException {
        ...
        try (Connection conn = conector.getConn()) {
            ...
            throw new DAOException("Error INSERTING new ATTEND: " + sql + "/" + attend.toString(), e);
        }
        return isSaved;
    }
    ...
    public boolean delete(Integer id) throws DAOException {
        ...
        try (Connection conn = conector.getConn()) {
            ...
            throw new DAOException("Error DELETING Attend by id: " + sql + "/" + id.toString(), e);
        }
        return isDeleted;
    ...
    public boolean update(Atendimento attend) throws DAOException {
        ...
        try (Connection conn = conector.getConn()) {
            ...
            throw new DAOException("Error UPDATING ATTEND: " + sql + "/" + attend.toString(), e);
        }
        return isUpdated;
    ...
    public Atendimento getByID(Integer id) throws DAOException {
        ...
        try (Connection conn = conector.getConn()) {
            ...
            attend = null;
            throw new DAOException("Error GETTING Attend by id: " + sql + "/" + id.toString(), e);
